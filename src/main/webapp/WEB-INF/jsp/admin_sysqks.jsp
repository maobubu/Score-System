...
<div style="padding: 70px 550px 10px">
    <form   method="post" action="querysysqk.html" class="form-inline"  id="searchform">
...
<div class="panel panel-default" style="width: 90%;margin-left: 5%">
    ...
    <div class="panel-body">
        <table class="table table-hover">
            ...
            <tbody>
            <c:forEach items="${sysqks}" var="sysqk">
            <tr>
                <td><c:out value="${sysqk.term_year}"></c:out></td>
                <td><c:out value="${sysqk.id}"></c:out></td>
                <td><c:out value="${sysqk.lab_id}"></c:out></td>
                <td><a href="sysqkdetail.html?id=<c:out value="${sysqk.id}"></c:out>"><button type="button" class="btn btn-success btn-xs">详情</button></a></td>
                <td><a href="updatesysqk.html?id=<c:out value="${sysqk.id}"></c:out>"><button type="button" class="btn btn-info btn-xs">编辑</button></a></td>
                <td><a href="deletesysqk.html?id=<c:out value="${sysqk.id}"></c:out>"><button type="button" class="btn btn-danger btn-xs">删除</button></a></td>
            </tr>
            </c:forEach>
            </tbody>
        </table>
