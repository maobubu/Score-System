...
<c:if test="${empty admin.adminId}">
    <script>
            alert("你没有权限访问,请先登录 ${admin.adminId}");
...
<div style="padding: 70px 550px 10px">
    <form   method="post" action="querydepartment.html" class="form-inline"  id="searchform">
    ...
    <div class="panel-body">
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td><a href="departmentdetail.html?departmentID=<c:out value="${department.departmentID}"></c:out>"><button type="button" class="btn btn-success btn-xs">详情</button></a></td>
                <td><a href="updatedepartment.html?departmentID=<c:out value="${department.departmentID}"></c:out>"><button type="button" class="btn btn-info btn-xs">编辑</button></a></td>
                <td><a href="deletedepartment.html?departmentID=<c:out value="${department.departmentID}"></c:out>"><button type="button" class="btn btn-danger btn-xs">删除</button></a></td>
            </tr>
            </c:forEach>
            </tbody>
        </table>
