...
<div style="position: relative;top: 10%;width: 80%;margin-left: 10%">
            <form action="departments_add_do.html" method="post" id="adddepartment" >
                <div class="form-group">
                    <label for="name">院系名称</label>
                    <input type="text" class="form-control" name="name" id="name" placeholder="请输入院系名称">
                </div>
                <div class="form-group">
                    <label for="departmentID">院系号码</label>
                    <input type="text" class="form-control" name="departmentID" id="departmentID"  placeholder="请输入院系号码">
