...
<div class="col-xs-6 col-md-offset-3" style="position: relative;top: 10%">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form action="lab_edit_do.html?id=${detail.id}" method="post" id="editlab" >

                <div class="input-group">
                    <span  class="input-group-addon"实验室名</span>
                    <input type="text" class="form-control" name="name" id="name" value="${detail.name}">
                </div>
                <div class="input-group">
                    <span class="input-group-addon">实验室院系号码</span>
                    <input type="text" class="form-control" name="departmentID" id="departmentID" value="${detail.departmentID}" >
                </div>
