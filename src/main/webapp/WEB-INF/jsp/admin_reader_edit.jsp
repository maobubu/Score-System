        ...
        <div class="panel-body">
            <form action="reader_edit_do.html?id=${readerInfo.readerId}" method="post" id="readeredit" >
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="permission" id="permission" value="${readerInfo.permission}" >
                </div>
                <div class="input-group">
                    <span class="input-group-addon">所属院系</span>
                    <input type="text" class="form-control" name="departmentID" id="departmentID" value="${readerInfo.departmentID}" >
                </div>
                ...
                <script>
                    ...
                    $("#readeredit").submit(function () {
                        if($("#name").val()==''||$("#author").val()==''||$("#publish").val()==''||$("#isbn").val()==''||$("#introduction").val()==''||$("#language").val()==''||$("#price").val()==''||$("#pubdate").val()==''||$("#classId").val()==''||$("#pressmark").val()==''||$("#state").val()==''||$("#departmentID").val()==''||$("#permission").val()==''){
                            alert("请填入完整读者信息！");
