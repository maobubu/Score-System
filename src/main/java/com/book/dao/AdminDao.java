...
public class AdminDao {
    ...
    private static final String SELECT_WEIGHT="update admin set weight = ? where admin_id = ?";
    ...
    public int editWeight(int adminId,int weight){
        return jdbcTemplate.update(SELECT_WEIGHT,weight,adminId);
    }
