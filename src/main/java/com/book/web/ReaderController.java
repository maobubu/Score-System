...
public class ReaderController {
    ...
    public String readerDelete(HttpServletRequest request,RedirectAttributes redirectAttributes){
        ...
        boolean success_card=readerCardService.deleteReaderCard(readerId);


        if(success&&success_card){
    ...
    public String readerInfoEditDo(HttpServletRequest request,String name,String sex,String birth,String address,String telcode,int departmentID,int permission,RedirectAttributes redirectAttributes){
        ...
        if(!oldName.equals(name)){
            ...
            readerInfo.setDepartmentID(departmentID);
            readerInfo.setPermission(permission);
    ...
    public String readerInfoAddDo(String name,String sex,String birth,String address,String telcode,int readerId,int departmentID,int permission,RedirectAttributes redirectAttributes){
        SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd");
        Date nbirth=new Date();
        try{
            java.util.Date date=sdf.parse(birth);
